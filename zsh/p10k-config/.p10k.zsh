# Generated by Powerlevel10k configuration wizard on 2024-02-02 at 10:52 CST.
...
# lightest, 12h time, angled separators, blurred heads, blurred tails, 2 lines,
# disconnected, left frame, sparse, many icons, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=051
